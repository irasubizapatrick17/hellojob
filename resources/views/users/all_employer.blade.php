                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box" style="margin-top: 31px;">
                            <h4 class="m-t-0 header-title"><b>All Job Seekers</b></h4>
                            ...
                            <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="7">
                                ...
                                @foreach($company AS $value)
                                    <tr>
                                        <td>{{++$i}}</td>
                                        <td ><img src="./company/{{$value->company_profile}}" class="img-responsive client-logo" style="width: 60px;"></td>
                                        <td>{{$value->company_name}} </td>
                                        <td>{{$value->email}} </td>
                                        <td>{{$value->telephone}}</td>
                                        <td>{{$value->working_area}}</td>

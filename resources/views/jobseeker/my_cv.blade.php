                    ...
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            ...
                            <ul class="dropdown-menu drop-menu-right" role="menu">
                                <li><a href="form-wizard.html#">Action</a></li>
                                <li><a href="form-wizard.html#">Another action</a></li>
                                <li><a href="form-wizard.html#">Something else here</a></li>
                                <li class="divider"></li>
                                <li><a href="form-wizard.html#">Separated link</a></li>
                            </ul>
                        </div>

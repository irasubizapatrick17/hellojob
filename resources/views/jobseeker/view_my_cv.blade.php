            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">MY CURRICULUM VITAE</h4>
                        <ol class="breadcrumb">
                            <li>
                                <a href="#">Profile</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title"><b>MY PROFILE</b></h4>

                            <p class="text-muted m-b-30 font-13">
                                This is the resume of personal information
                                <!-- Custom width modal -->

                            </p>
                            <?php $i=0;?>
                            @foreach($job_seeker AS $value)
                                <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#editmy_cv<?php echo $i;?>" style="
    margin-left: 903px;margin-top: -73px; ">Update Your Profile</button>
                            <div class="row">
                                <div class="col-md-4">

                                    <h4>Personal Information</h4>
                                    <center>
                                        <img src="./jobseekers/{{$value->profile}}" class="img-circle" style="margin-left: -299px;width: 53px;">
                                    </center>
                                    <h5 style="color: steelblue"> MY NAME : {{$value->first_name}} {{$value->last_name}}</h5>
                                    <h5 style="color: steelblue">Gender  : {{$value->gender}}</h5>
                                    <h5 style="color: steelblue">Date of Birth: {{$value->dob}}</h5>
                                    <h5 style="color: steelblue">Status : {{$value->personal_status}}</h5>
                                    <h5 style="color: steelblue">Telephone : {{$value->telephone}}</h5>
                                    <h5 style="color: steelblue">Nationality : {{$value->nationality}}</h5>
                                    <h5 style="color: steelblue">District : {{$value->district}}</h5>


                                </div>
                                <div class="col-md-4">
                                    <h4>Academic Information</h4>
                                    <h5 style="color: steelblue">Level Of Education: {{$value->academic}} </h5>
                                    <h5 style="color: steelblue">Subject : {{$value->subject}}</h5>

                                </div>
                                <div class="col-md-4">
                                    <h4>Experience</h4>
                                 <h5 style="color: steelblue">  Company Name : {{$value->institution}}  </h5>
                                    <h5 style="color: steelblue"> Start Date  : {{$value->start_date}}</h5>
                                    <h5 style="color: steelblue">End Date  : {{$value->end_date}}</h5>
                                    <h5 style="color: steelblue">Company Location  : {{$value->personal_location}}</h5>
